...
public class ReviewsSitePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		reviewRepo.save(new MovieReview("/images/thebiglebowski.jpg", "The Big Lebowski", "1998",
		...
		reviewRepo.save(new MovieReview("/images/terminator2.jpg", "Terminator 2: Judgment Day", "1991",
		...
		reviewRepo.save(new MovieReview("/images/thematrix.jpg", "The Matrix", "1999",
				...
				r, action, sciFi));
		reviewRepo.save(new MovieReview("/images/theproposal.jpg", "The Proposal", "2009",
		...
		reviewRepo.save(new MovieReview("/images/thorragnarok.jpg", "Thor: Ragnorak", "2017",
		...
		reviewRepo.save(new MovieReview("/images/21jumpstreet.jpg", "21 Jump Street", "2012",
		...
		reviewRepo.save(new MovieReview("/images/thebigsick.jpg", "The Big Sick", "2017",
		...
		reviewRepo.save(new MovieReview("/images/harrypotter7-2.jpg", "Harry Potter and the Deathly Hallows: Part 2",
				"2011",
		...
		reviewRepo.save(new MovieReview("/images/frozen.jpg", "Frozen", "2013",
		...
		reviewRepo.save(new MovieReview("/images/wonderwoman.jpg", "Wonder Woman", "2017",
		...
		reviewRepo.save(new MovieReview("/images/moana.jpg", "Moana", "2016", "\r\n"
				...
				pg, animation, adventure, comedy));
		reviewRepo.save(new MovieReview("/images/lionking.jpg", "The Lion King", "1994",
		...
		reviewRepo.save(new MovieReview("/images/aladdin.jpg", "Aladdin", "1992",
		...
		reviewRepo.save(new MovieReview("/images/interstellar.jpg", "Interstellar", "2014",
		...
		reviewRepo.save(new MovieReview("/images/americanpsycho.jpg", "American Psycho", "2000", "\r\n"
				...
				r, crime, drama));
		reviewRepo.save(new MovieReview("/images/starwarsforceawakens.jpg", "Star Wars: The Force Awakens", "2015",
